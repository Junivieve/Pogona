...
creditsPanel.add(new UIText("credits", room_width/2, 15, "Made in 6 days for the GameOff 2023 Game Jam by Juniper & Farolino"));
startbutton = menu.add(new UIButton("startButton", 30, 8, 60, 30, "Restart", sButton));
//menu.destroy();
